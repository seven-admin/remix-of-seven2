...
export function PortalLayout() {
  ...
  // Verificar se é página de detalhe de empreendimento (título gerenciado pelo componente)
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-xs text-sidebar-foreground/60">Corretor</p>
            </div>
            <button
      ...
      {/* Mobile Navigation */}
      <nav className="md:hidden border-b border-sidebar-border bg-sidebar overflow-x-auto">
